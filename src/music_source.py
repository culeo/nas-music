...
class MusicSource:
    ...
    def get_media_source(self, music_item: dict, quality: str, platform=None):
        return self._call_js_function(
            "getMediaSource", music_item, quality, platform=platform
        )

    def get_lyric(self, music_item: dict, platform=None):
        return self._call_js_function("getLyric", music_item, platform=platform)
    ...
    def get_recommend_sheets_by_tag(self, *args, platform=None):
        return self._call_js_function(
            "getRecommendSheetsByTag", *args, platform=platform
        )
